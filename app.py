...
min_mittelwert = min(comparison_df[mittelwert_col1].min(), comparison_df[mittelwert_col2].min(), mean_df[mean_col].min())
max_mittelwert = max(comparison_df[mittelwert_col1].max(), comparison_df[mittelwert_col2].max(), mean_df[mean_col].max())
