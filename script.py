...
st.set_page_config(page_title="Immobilien Südtirol", page_icon=":bar_chart:", layout="wide")
...
st.markdown("In der folgenden Applikation können Sie die Schätzung von Immobilienp verschiedener Art in Südtiroler Gemeinden vergleichen. Dazu werden die Daten aller Jahre vom zweiten Semester verwendet. Der mittlere Immobilienwert wird berechnet indem die Summe von minimaler und maximaler Schätzung halbiert wird.")
